...
async function handleCreate(req, res) {
  ...
  try {
    const queryStr = `
      INSERT INTO LISTING (
        LISTING_QUANTITY, LISTING_PRICE, LISTING_DATE, ITEM_ID, USER_ID, IMAGE_URL
      )
...
async function handleSearch(req, res) {
  ...
  try {
    const queryStr =`
      SELECT 
        LISTING.LISTING_ID, LISTING.LISTING_PRICE, LISTING.LISTING_QUANTITY, LISTING.LISTING_DATE, LISTING.IMAGE_URL,
